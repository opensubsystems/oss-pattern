...
/**
 * Interface representing object with set of parameters that can be used to 
 * further characterize the behavior of the object.
 *
 * @author bastafidli
 */
public interface ParametrizedObject 
{
    /**
